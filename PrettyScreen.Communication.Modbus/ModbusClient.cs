...
using PrettyScreen.Core.Extensions;
using System;
using System.Net;
...
{
    [AdapterType(AdapterType.ModbusTcp, AdapterType.ModbusUdp)]
    public class ModbusClient : DataAdapterBase
    {
        ...
        public ModbusClient(IDataPointService dps, AdapterConfiguration config, AdapterType adapterType)
